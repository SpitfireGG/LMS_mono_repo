  ...
  return (
    ...
    >
      ...
      >
        <div
          className={cn(
            "content-stretch flex font-medium gap-[25px] items-center leading-[normal] relative flex-1 transition-colors duration-300",
        ...
        >
          <div ref={descriptionRef} className="overflow-hidden">
            <div
              ...
              aria-hidden="true"
            >
              <div className="absolute inset-[-1px_0_0_0] border-t border-white/30"></div>
            </div>
            <p className="font-normal h-auto leading-[normal] relative shrink-0 text-[18px] text-white/90 w-full whitespace-pre-wrap pb-[14px] max-xl:pb-[10px] max-sm:pb-[5px]">
              {description}
            </p>
          </div>
        </div>
