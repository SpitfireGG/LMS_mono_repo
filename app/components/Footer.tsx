...
export default function Footer({ className }: { className?: string }) {
  return (
    <div
      className={cn(
        "flex flex-col items-start py-0 relative w-full",
        className
      )}
    >
      <div
        className={cn(
          "bg-[#0a4a29] flex flex-col items-center relative rounded-tl-[45px] rounded-tr-[45px] shrink-0 w-full",
          "pb-[50px] pt-[55px] max-lg:pb-[40px] max-lg:pt-[40px] max-md:pb-[30px] max-md:pt-[40px]"
        )}
      >
        <div
          className={cn(
            "flex flex-col items-start w-full max-w-[1440px] mx-auto",
            "gap-[50px] max-lg:gap-[40px] max-md:gap-[30px]",
            "px-[100px] max-xl:px-[60px] max-sm:px-[30px]"
          )}
        >
          ...
          <div className="flex justify-between items-center relative w-full gap-[20px] max-lg:flex-wrap">
            ...
            <div className="flex items-center gap-[12px]">
              <Logo className="w-[36px] h-[36px] text-white" />
              <p className="font-medium text-[18px] leading-[normal] text-white whitespace-nowrap">
          ...
          <div className="flex gap-[30px] items-center justify-between relative shrink-0 w-full max-md:flex-col max-md:items-start">
            ...
            <div className="flex flex-col gap-[27px] items-start relative flex-2 max-lg:flex-3">
              <div className="flex flex-col items-start relative">
                <div className="bg-[#056839] flex flex-col items-start px-[7px] py-0 relative rounded-[7px]">
                  <p className="font-medium leading-[normal] relative shrink-0 text-[20px] text-white">
                    Contact us:
                  </p>
                </div>
              </div>
              <div className="flex flex-col font-normal gap-[20px] items-start relative text-[18px] text-white">
                ...
                <p className="leading-[normal] relative">Phone: +61 2 8000 0000</p>
                <div className="leading-[normal] relative">
                  <p className="mb-0">Address: Melbourne, VIC</p>
                  <p>Australia</p>
                </div>
              </div>
            </div>
        ...
        <div className="flex font-normal gap-x-[41px] gap-y-[10px] items-center justify-between relative text-[16px]/[28px] text-white w-full flex-wrap">
          <p className="relative">© 2026 NAATI EXCELLENCE ACADEMY. All Rights Reserved.</p>
