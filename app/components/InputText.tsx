...
export default function InputText({
  ...
  const baseInputClassName =
    "bg-white border border-black border-solid flex items-start overflow-clip px-[30px] py-[18px] max-sm:px-[20px] max-sm:py-[16px] relative rounded-[14px] shrink-0 w-full font-normal text-[18px]/[21px] text-black placeholder:text-[#58645c] focus:outline-none focus:ring-2 focus:ring-[#0a4a29] focus:ring-offset-2";
